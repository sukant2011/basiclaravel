...
</td><td style="width: 30px;background-color: #F0F8FA;" width="30" valign="middle"><span style="background-color: #F0F8FA;">&nbsp;</span></td></tr><tr><td style="height: 20px;" colspan="3" valign="top"><br></td></tr><tr><td style="width: 30px;" width="30" valign="top"><br></td><td style="width: 500px;" width="500" valign="top"><span style="font-family: Arial,Helvetica,sans-serif;"> <table style="border-collapse: collapse; border-spacing: 0; padding: 0;" border="0" cellspacing="0" cellpadding="0" width="499" height="108" align="left"><tbody><tr><td valign="top">Hi <span style="text-transform: capitalize;"><span>,</span></span></td></tr><tr><td style="height: 25px;" valign="top"><br></td></tr><tr><td valign="top"><p>We have received your request for password reset. Kindly click below to reset your password.</p>
<p style="width: 100%;text-align: center;float: left;margin-top: 18px;
"><a href="{{ url('password/reset/'.$token) }}" ><img src="{{asset('public/img/reset-password.png')}}"></a></p></td></tr></tbody></table></span></td><td style="width: 30px;" width="30" valign="top"><br></td></tr><tr><td style="height: 20px;" colspan="3" valign="top"><br></td></tr><tr><td style="width: 30px;background-color: #F0F8FA;" width="30" valign="top"><br></td><td style="background-color: #F0F8FA; padding: 15px 0;" valign="top"><span style="background-color: #eeeeee;"><span style="font-family: Arial,Helvetica,sans-serif;"> <table style="border-collapse: collapse; border-spacing: 0; text-align: justify; padding: 0;" border="0" cellspacing="0" cellpadding="0" align="left"><tbody><tr><td style="width: 500px; height: 20px;" width="500" valign="top" align="center"><p style="float: left;text-align: left;">Cheers,<br>Flying Chalks Team</p><p style="
    float: left;
    width: 100%;
    text-align: center;
    /* margin: 0; */
...
<div style="padding: 0px; text-align: center; margin: 0px auto; width: 45%;">
	...
	<img style="line-hight:10px;" src="{{asset('public/img/heart_like.png')}}"> 
